...
//           withCredentials: true, // ✅ keep if backend uses session cookies
//         });
//         if (res.data.success) {
...
//     try {
//       const res = await axios.delete(`http://localhost:3000/api/wardrobe/${wardrobeId}`, {
...
//       toast.error("⚠️ Error deleting wardrobe");
//     }
//   };
...
//   if (!user)
//     return <p className="text-center mt-10 text-red-500">No user data</p>;
...
//       {/* Wardrobe Section */}
//       <h2 className="text-xl mt-5 font-bold text-gray-800 mb-4">
//         My Saved Wardrobes
//       </h2>
//       <div className="grid grid-cols-2 gap-10 mt-10">
//         {user.wardrobes.map((wardrobe, wIndex) => (
//           <div key={wIndex} className="bg-gray-50 p-4 rounded-lg shadow relative">
//              <button
...
//                     />
//                     <p className="mt-2 text-gray-700 text-sm">{outfit.item}</p>
//                   </div>
//                 ))
//               ) : (
//                 <p className="text-gray-500">No outfits in this wardrobe.</p>
//               )}
//             </div>
//           </div>
//         ))}
